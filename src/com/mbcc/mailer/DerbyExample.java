...
public class DerbyExample {
	...
	public static void main(String[] args) {
		DerbyExample dao = new DerbyExample();
	...
	/**
	 * The buildCoffeeTable method creates the Coffee table and adds some rows to
	 * it.
	 */
	...
	/**
	 * The buildCustomerTable method creates the Customer table and adds some rows
	 * to it.
	 */
		...
		try {
			...
			try {
				...
				while (resultSet.next()) {
					System.out.println("  " + resultSet.getString("CustomerNumber") + " " + resultSet.getString("Name")
			...
			try {
				...
				while (resultSet.next()) {
					System.out.println("  " + resultSet.getString("Description") + " " + resultSet.getString("ProdNum")
			...
			try {
				...
				ResultSet resultSet = stmt.executeQuery("SELECT * FROM UnpaidOrder");
				System.out.println("\nPrinting unpaid orders...");
				while (resultSet.next()) {
					System.out.println("  " + resultSet.getString("CustomerNumber") + " "
							+ resultSet.getString("ProdNum") + " " + resultSet.getString("OrderDate") + " "
